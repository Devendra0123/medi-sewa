...
import { bookSearchQuery, searchQuery } from '../../utils/query'
...
const Index = ({ products, books }) => {
    ...
    return (
        <div>
            <h2 className='text-center font-bold text-lg font-[poppins]'>
                Second Hand Marketplace
            </h2>
            <p className="text-center font-medium text-xl font-['lobster'] text-orange-500">

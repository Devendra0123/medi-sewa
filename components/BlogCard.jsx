...
const BlogCard = ({ post }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
            ...
            <div className="relative overflow-hidden shadow-md pb-64 mb-6 bg-orange-300 rounded">
                <img src={urlFor(post.image).url()} alt="image" className="object-top absolute h-72 w-full object-contain  shadow-lg rounded-t-lg lg:rounded-lg" />
            </div>

      ...
      <div className='w-[30rem] h-[27rem] flex flex-col items-center shadow-lg rounded'>
        ...
        <div className='w-full flex flex-col items-center mt-[20px]'>
          ...
          <div className='w-[80%] flex items-center justify-between p-[10px] shadow-lg mb-[10px]'>
            ...
            <svg width="24" height="24" fill='orange' xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 10c-1.104 0-2-.896-2-2s.896-2 2-2 2 .896 2 2-.896 2-2 2m0-5c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3m-7 2.602c0-3.517 3.271-6.602 7-6.602s7 3.085 7 6.602c0 3.455-2.563 7.543-7 14.527-4.489-7.073-7-11.072-7-14.527m7-7.602c-4.198 0-8 3.403-8 7.602 0 4.198 3.469 9.21 8 16.398 4.531-7.188 8-12.2 8-16.398 0-4.199-3.801-7.602-8-7.602"/></svg>
          </div>
        ...
        <button type='button' onClick={handleOrder} className='w-[80%] p-[10px] bg-orange-400 mt-[20px] font-medium'>
          Confirm Order
        </button>
      </div>
    </div>
